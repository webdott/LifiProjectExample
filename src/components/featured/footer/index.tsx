		...
		<div className={styles.container}>
			<div className={styles.footer}>
				...
				<div className={styles.disclaimer}>
					<span>
						{' '}
						<span>gamblr.xyz</span> is a unique betting service built directly
						on the blockchain. At <span>gamblr.xyz</span> there is no company or
						"House" that bets against you or ever holds any of your funds.
						Everything is run through smart contracts powered by Azuro - a
						decentralized blockchain ecosystem that makes this all possible so
						you can bet freely while still being fully in control of your own
						funds.
					</span>
				</div>
				...
				<div className={styles.contracts}>
					...
					<div className={styles.officialSection}>
						<div className={styles.leftSection}>
							{officialContract?.map(
								(e: OfficialContractProps, index: number) => (
