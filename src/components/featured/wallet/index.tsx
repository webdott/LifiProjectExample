        ...
        <div className={styles.leftSidebar}>
          <div className={styles.container}>
            ...
            <div className={styles.nav}>
              <Button btnType={ButtonType.medium} text={navData[0].name} onClick={navigateToHome} />
              <Button btnType={ButtonType.medium} text={navData[1].name} onClick={navigateToLive} />
            </div>
          </div>
        </div>
