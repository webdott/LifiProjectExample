...
export const ABI_PAYLOAD = [
  ...
  {
    inputs: [{ internalType: 'uint64', name: 'waitTime', type: 'uint64' }],
    name: 'ClaimTimeout',
    type: 'error',
  },
  ...
  {
    inputs: [{ internalType: 'enum SafeCast.Type', name: 'to', type: 'uint8' }],
    name: 'SafeCastError',
    type: 'error',
  },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint64', name: 'newClaimTimeout', type: 'uint64' }],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'address', name: 'newDataProvider', type: 'address' }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'uint48', name: 'leaf', type: 'uint48' },
      { indexed: false, internalType: 'uint256', name: 'amount', type: 'uint256' },
    ],
    name: 'LiquidityAdded',
    type: 'event',
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint128', name: 'newMinDepo', type: 'uint128' }],
    name: 'MinDepoChanged',
    type: 'event',
  },
  {
  ...
  },
  {
    inputs: [],
    name: 'access',
    outputs: [{ internalType: 'contract IAccess', name: '', type: 'address' }],
  ...
  },
  {
    ...
    name: 'addReserve',
    outputs: [{ internalType: 'uint128', name: 'affiliatesReward', type: 'uint128' }],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{ internalType: 'uint64', name: 'newClaimTimeout', type: 'uint64' }],
  ...
  {
    inputs: [{ internalType: 'uint128', name: 'newMinDepo', type: 'uint128' }],
    name: 'changeMinDepo',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{ internalType: 'uint64', name: 'newWithdrawTimeout', type: 'uint64' }],
  ...
  },
  {
    ...
    outputs: [{ internalType: 'uint256', name: 'claimedAmount', type: 'uint256' }],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [],
    name: 'getLeaf',
    outputs: [{ internalType: 'uint48', name: 'leaf', type: 'uint48' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    inputs: [],
    name: 'getReserve',
    outputs: [{ internalType: 'uint128', name: 'reserve', type: 'uint128' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
    inputs: [
      ...
      { internalType: 'uint64', name: 'affiliateFee', type: 'uint64' },
    ],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [
      { internalType: 'uint48', name: 'depNum', type: 'uint48' },
